---
title: TensorFlow2自编码器
date: '2019-11-17'
categories: 'TensorFlow2'
description: 介绍自编码器在TensorFlow2中如何实现。
tags: 
    - TensorFlow2教程
updated: 
---
...
## 自编码器实战
通过普通的神经元神经网络，利用低维隐层捕获特征，实现如下模型。![](/asset/2019-11-17/AE_structure.png)
```python
"""
Author: Zhou Chen
Date: 2019/11/17
...
VAE学习的是数据分布，依据该分布sample出结果。![](/asset/2019-11-17/vae.png)
```python
"""
Author: Zhou Chen
Date: 2019/11/17
